...
def calculate_time_affinity(
    ...
    # Get image brightness — prefer perceived_brightness (PIL pixel median)
    # over avg_lightness (palette-based BT.709) for better accuracy.
    img_lightness = (
        image_palette.perceived_brightness
